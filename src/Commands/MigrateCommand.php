...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'moduletax:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the ModuleTax project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for ModuleTax project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('moduletax:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
